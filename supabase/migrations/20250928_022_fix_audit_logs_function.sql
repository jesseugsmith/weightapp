-- Drop and recreate the get_audit_logs function with better error handling
...
BEGIN
    ...
    SELECT 
        ...
        al.entity_type,
        al.entity_id,
        COALESCE(p.email, 'Unknown User') as performed_by,
        al.old_values,
        al.new_values,
        al.created_at
...
-- Update the RLS policy to use the permission system
